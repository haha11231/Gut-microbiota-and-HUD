...
sample_info <- read.csv('PcOA.sample.info.csv', row.names=1)
data <- read.csv('PcOA.otu.test.csv', header = T, row.names=1)
...
tree  <- read_tree("PcOA.tree")
otu.tab <- read.csv('PcOA.otu.test.csv', header = T, row.names=1)
sample_info <- read.csv('PcOA.sample.info.csv', header = T, row.names=1)
